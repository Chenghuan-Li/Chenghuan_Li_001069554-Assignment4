...
public class UF_HWQUPC implements UF {
    ...
    public static int count(int n) {
    	...
    	UF_HWQUPC unionf = new UF_HWQUPC(n);
    	Random r =new Random();
		int  count = 0;
		loop:
    ...
    public static int count3(int n) {
       	//chenghuan li 001069554
    	UF_HWQUPC unionf = new UF_HWQUPC(n,false);
    	Random r =new Random();
		int  count = 0;
		loop:
		while ( unionf.count> 1) 
    ...
    public static void main(String[] args) {
    	//chenghuan li 001069554
    	int[] n = {100,200,400,800,1000,1600,2000,3000,4000,5000};
